...
/** FilterDrawer — Sort, Filter, and Compare controls in a slide-in drawer.
 *  Receives all state and handlers from useFishDex via props — no state here.
 *  Desktop: slides from right. Mobile: sheets up from bottom. */
...
export default function FilterDrawer({
  ...
  return (
    <>
      ...
      {/* Drawer panel */}
      <aside className={styles.drawer} aria-label="Sort and filter options">
        <div className={styles.head}>
          <span className={styles.title}>Sort / Filter</span>
